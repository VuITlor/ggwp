            ...
            <tr v-for="(product, index) in products" :key="index">
              ...
              <td>
                <img v-if="product.images && product.images.length"
                  ...
                  class="product-image mx-auto" style="width: 300px; height: 200px; object-fit: cover;" />
              </td>
              <td>
                ...
                <div class="modal-body">
                  ...
                  <div class="mb-3">
                    ...
                    <div v-for="(sku, index) in formData.skus" :key="index" class="card mb-3 p-3">
                      ...
                      <button type="button" class="btn btn-secondary mt-2" @click="removeSku(index)">
                        Xóa Size
                      </button>
                    </div>
                    <button type="button" class="btn btn-success" @click="addSku">
                      Thêm Size
                    </button>
                  </div>
